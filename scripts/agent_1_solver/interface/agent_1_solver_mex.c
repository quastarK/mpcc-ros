...
extern void (agent_1_solver_float *x, agent_1_solver_float *y, agent_1_solver_float *l, agent_1_solver_float *p, agent_1_solver_float *f, agent_1_solver_float *nabla_f, agent_1_solver_float *c, agent_1_solver_float *nabla_c, agent_1_solver_float *h, agent_1_solver_float *nabla_h, agent_1_solver_float *hess, solver_int32_default stage, solver_int32_default iteration);
agent_1_solver_extfunc pt2function_agent_1_solver = &;


/* Some memory for mex-function */
static agent_1_solver_params params;
static agent_1_solver_output output;
static agent_1_solver_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help agent_1_solver_mex' for details.");
    }    
	if (nlhs > 3) 
	{
    ...
    if( mxGetM(par) != 595 || mxGetN(par) != 1 ) 
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [595 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,595);

	}


	#if SET_PRINTLEVEL_agent_1_solver > 0
	...
	/* call solver */
	exitflag = agent_1_solver_solve(&params, &output, &info, fp, pt2function_agent_1_solver);
